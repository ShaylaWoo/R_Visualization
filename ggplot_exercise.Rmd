...
fig115 <- cel %>% 
  filter(congress==115) 
Gender <- recode(fig115$female,`0`="Male",`1`="Female")
fig115 <- add_column(fig115,Gender)
ggplot(fig115,aes(x=dwnom1,y=all_pass,colour=Gender))+
  geom_point()+
...
Majority <- recode(fig115$majority,`0`="Minority",`1`="Majority")
fig115 <- add_column(fig115,Majority)
ggplot(fig115,aes(x=votepct,y=all_pass,color=Gender))+
  geom_point()+
...
ggplot(fig115,aes(y=les,x=Majority))+
  geom_boxplot()+
